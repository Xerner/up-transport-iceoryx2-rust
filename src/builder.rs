...
use up_rust::UStatus;
use crate::{listener_registry::ListenerRegistry, pubsub::PubSubSingleThreadWrapper, transport::UTransportIceoryx2};
...
impl UTransportIceoryx2Builder {
    ...
    pub(crate) fn publish_subscribe<Service>(transport: UTransportIceoryx2<Service>) -> Result<PubSubSingleThreadWrapper<Service>, UStatus>
    where
        Service: iceoryx2::service::Service
    {
        PubSubSingleThreadWrapper::new(transport)
    }
}
